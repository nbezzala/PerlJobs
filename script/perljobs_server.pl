...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{PERLJOBS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{PERLJOBS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
perljobs_server.pl - Catalyst Testserver

=head1 SYNOPSIS

perljobs_server.pl [options]
